...
export default function create() {
    ...
    <div className='flex justify-center items-center '>
        ...
        <input className="px-8 h-12 my-2  rounded-lg  bg-slate-900 text-purple-500" type="text" placeholder="Room Name">
    </input>
    <input className="px-8 h-12 my-2  rounded-lg  bg-slate-900 text-purple-500" type="text" placeholder="Room Type">
    </input>
    </div>
